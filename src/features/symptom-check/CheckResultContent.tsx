...
import { URGENCY_CONFIG, type UrgencyKey } from '@/shared/utils/urgency'
...
function Chip({ label }: { label: string }) {
  return (
    <span className="px-3 py-1 rounded-full text-xs bg-gray-50 border border-gray-200 text-gray-600">
      {label}
    </span>
  )
}
