...
const en: Dictionary = {
  ...
  dashboard: {
    ...
    catsEmptyTitle: 'First pet',
    noCats: 'Add a profile — symptom analysis will be more {accent}.',
    noCatsAccent: 'accurate',
    ...
    seeAll: 'All',
    signOut: 'Sign out',
    catSaved: 'Pet profile saved.',
    catAdded: 'Pet added.',
    catDeleted: 'Pet profile deleted.',
  ...
  check: {
    ...
    additionalCatInfoNeeded: 'What to clarify about the pet',
    homeCare: 'What to do',
