  ...
  return (
    <LegalDocument title="Согласие на обработку персональных данных" edition={editionOf(PD_CONSENT_VERSION)}>
      <LegalSection title="Кто и кому даёт согласие">
        <p>
          Отмечая согласие в сервисе «Лапка» (сайт lapka.my и мобильное приложение, далее —
      ...
      <LegalSection title="Кому поручается обработка">
        <p>
          ...
          OpenAI — анализ описаний симптомов, сведений о питомце, записей медицинской карты и
          фотографий; Expo — доставка
          обновлений мобильного приложения; Telegram — служебные уведомления администрации о
          запросах дополнительной проверки (только внутренний идентификатор, без адреса почты
          и имени). Я понимаю, что
