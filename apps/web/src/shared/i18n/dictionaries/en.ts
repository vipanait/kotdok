...
const en: Dictionary = {
  ...
  auth: {
    login: {
      ...
      errorApple: 'Failed to sign in with Apple',
    },
    register: {
    ...
    resetPassword: {
      ...
      subheading: 'At least 8 characters. Use something different from your old password.',
  ...
  admin: {
    statistics: {
      kicker: 'Admin',
      title: 'Statistics',
      subtitle: 'Registrations and symptom checks across all users.',
      ...
      chartSubtitle: 'Registrations and symptom requests by day.',
      days: '{n} days',
