...
export const en: Dictionary = {
  ...
  vetSummary: {
    htmlLang: 'en',
    checkColumns: ['Date', 'Urgency', 'What happened'] as [string, string, string],
    weightColumns: ['Date', 'Weight'] as [string, string],
    title: 'For the vet',
    entry: 'For the vet',
    pdfTitle: (name: string) => `Medical record: ${name}`,
    pet: 'Pet',
    important: 'Important',
    notStated: 'Not stated by the owner',
    weightFromForm: (kg: string) => `${kg} — from the pet form, no date`,
    weightOn: (kg: string, day: string) => `${kg} · ${day}`,
    vaccinations: 'Vaccinations',
    vaccinationColumns: ['Disease', 'Last', 'Product', 'Next'] as [string, string, string, string],
    parasites: 'Parasites',
    parasiteColumns: ['Against', 'Last', 'Product', 'Next'] as [string, string, string, string],
    parasiteGroups: { fleas_ticks: 'Fleas and ticks', worms: 'Worms' },
    noRecord: 'No records',
    overdueSince: (day: string) => `Overdue since ${day}`,
    visits: 'Vet visits in the last year',
    visitColumns: ['Date', 'Kind', 'Diagnosis', 'Prescriptions'] as [string, string, string, string],
    noVisits: 'No visits recorded in the last year',
    weight: 'Weight',
    noWeights: 'No measurements',
    checks: 'Latest checks in Lapka',
    noChecks: 'No checks yet',
    footer: (day: string) => `Compiled by the owner in the Lapka app on ${day}. Not a veterinary document.`,
    page: 'Page',
    send: 'Send PDF',
    preparing: 'Preparing the PDF…',
    failed: 'Could not prepare the PDF',
    retry: 'Try again',
  ...
  errors: {
    ...
    recordDone: 'Something done cannot be changed: the record stays in the history. A wrong record can be deleted.',
