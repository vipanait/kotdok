 ...
 * always are). Anything else — a soft sign, which may be either gender, other
 * vowels, Latin letters, several words — returns null, and the caller uses a
 * sentence that needs no case. A wrong ending on someone's pet reads worse
